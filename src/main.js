...
const createShowMoreBtn = function () {
...
const createFilmsElement = function () {
...
render(createFilmsElement(), main);

const filmsContainer = document.querySelector(`.films-list .films-list__container`);
for (let i = 0; i < NUMBER_OF_CARDS_IN_MAIN; i++) {
  render(createCard(), filmsContainer);
}
...
render(createShowMoreBtn(), filmsList);
